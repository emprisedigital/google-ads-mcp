...
from google.ads.googleads.v24.enums.types.content_label_type import ContentLabelTypeEnum
from google.ads.googleads.v24.enums.types.criterion_type import CriterionTypeEnum
