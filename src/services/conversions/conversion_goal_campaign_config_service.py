...
from google.ads.googleads.v24.resources.types.conversion_goal_campaign_config import (
    ConversionGoalCampaignConfig,
)
from google.ads.googleads.v24.services.services.conversion_goal_campaign_config_service import (
...
def register_conversion_goal_campaign_config_tools(mcp: FastMCP[Any]) -> None:
    ...
    @mcp.tool
    async def mutate_configs(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
    ...
    @mcp.tool
    async def update_config(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
        resource_name: str,
