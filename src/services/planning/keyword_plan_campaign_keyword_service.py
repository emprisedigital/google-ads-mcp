...
from google.ads.googleads.v24.resources.types.keyword_plan_campaign_keyword import (
    KeywordPlanCampaignKeyword,
)
from google.ads.googleads.v24.services.services.keyword_plan_campaign_keyword_service import (
    KeywordPlanCampaignKeywordServiceClient,
)
from google.ads.googleads.v24.services.types.keyword_plan_campaign_keyword_service import (
...
def register_keyword_plan_campaign_keyword_tools(mcp: FastMCP[Any]) -> None:
    ...
    @mcp.tool
    async def mutate_kws(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
    ...
    @mcp.tool
    async def create_kw(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
        keyword_plan_campaign: str,
        text: str,
        match_type: str,
    ...
    @mcp.tool
    async def update_kw(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
        resource_name: str,
        text: Optional[str] = None,
    ...
    @mcp.tool
    async def remove_kw(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
        resource_name: str,
    ) -> str:
